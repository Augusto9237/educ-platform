...
export function CardAssessment() {
    return (
        <div className="relative flex flex-1 flex-col p-3 justify-center gap-1.5 w-full rounded-xl shadow-lg  bg-gradient-to-r from-backgroundColor-500/80 to-backgroundColor-500/30">
