...
export function Sidebar() {
    return (
        <section className="group max-lg:hidden flex  fixed left-0 w-20 py-4 rounded-sm h-screen bg-backgroundColor-100 shadow-lg hover:w-52 delay-80 duration-500">
            <div className="flex flex-col flex-1 gap-8 hover:pl-7">
